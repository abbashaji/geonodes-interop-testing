...
v2: fixed geometry_node_bake_single call to pass bake_id (the
NodesModifierBake entry's own bake_id), not a list index -- v1 crashed with
"keyword bake_index unrecognized" before any assertions ran.
"""
