...
shape already exists:
    ...
    xvfb-run blender --python alembic_export__curves__basic_v1.py
...
def build_scene():
    ...
    align_rotation = nodes.new("GeometryNodeAlignRotationToVector")  # orient strand along face normal
    ...
    links.new(input_normal.outputs["Normal"], align_rotation.inputs["Vector"])
